...
def generate_fragment_message(username, ton_amount):
    ...
    # Utiliser le format Markdown avec l'adresse du wallet comme lien
...
*• Wallet:* [UQBBlxK8VBxEidbxw4oQVyLSk7iEf9VPJxetaRQpEbi-XDPR](https://tonviewer.com/{wallet_address})
